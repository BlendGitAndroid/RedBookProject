    ...
    const renderQuickLogin = () => {
        ...
        const styles = StyleSheet.create({
            ...
            icon_arrow: {
                ...
                resizeMode: 'contain',
                marginLeft: 6,
                transform: [{ rotate: '180deg', }]  //设置旋转180度
            },
            wxLoginButton: {
                width: '100%',
                height: 56,
        ...
        return (
            <View style={styles.root}>
                ...
                <View style={styles.pwdLayout}>
                    <TextInput
                        style={[styles.phoneInput, styles.pwdInput]}    //样式合并
                        placeholderTextColor="#bbb"
                        placeholder='输入密码'
                        autoFocus={false}
                        keyboardType='number-pad'
                ...
                <TouchableOpacity
                    ...
                    onPress={() => {
                        LayoutAnimation.easeInEaseOut();    //设置布局动画
                        setLoginType('quick')
                    }}
                >
