...
const BAR_HITHR = StatusBar.currentHeight || 48
...
export default observer(() => {
    ...
    const renderInfo = () => {
        ...
        const styles = StyleSheet.create({
            avatarLayout: {
                width: '100%',
                flexDirection: 'row',
                alignItems: 'flex-end', //反向布局  从下到上布局
                padding: 16,
            },
            avatarImg: {
                width: 96,
    ...
    return (
        <View style={styles.root}>
            <Image
                style={[styles.bgImg, { height: bgImgHeight + BAR_HITHR + 16 }]}    //计算背景图片的高度，状态栏 + 16
                source={icon_mine_bg}
            />
            {renderTitle()}
            <ScrollView
